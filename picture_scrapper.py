...
def infoScrapper(pageUrl):
    ...
    for z in range(len(booksPerPage)):
        ...
        with open('TUNED_Final_description_list_with_pic_links.csv', 'a', encoding='utf-8') as csvFile:
...
with open('TUNED_Final_description_list_with_pic_links.csv', 'w', encoding='utf-8') as csvFile:
    csvEditor = csv.writer(csvFile, delimiter=',', quotechar='"')
...
# infoScrapper('https://oz.by/books/?availability=1;2&nw=1&sort=novelty_desc')
